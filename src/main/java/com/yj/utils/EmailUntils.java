...
public class EmailUntils {
    ...
    //发件人昵称
    private static final String senderNick = "“健丽宝”服装租赁工作室";
    //主题
    private static final String emailSubject = "来自“健丽宝”的通知";
    ...
    public static boolean sendEmail(String receive ,String code) {
        try {
            ...
            String sendHtml = "尊敬的客户您好！<hr>【健丽宝】激活码为：<span style='color:blue;'>"+code+"</span>，本激活码的有效时间为5分钟，请勿告知他人！";
